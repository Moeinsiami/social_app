...
class TicketForm(forms.Form):
    ...
    message = forms.CharField(widget=forms.Textarea(attrs={'class': 'form-control', 'rows': "3"}), required=True,
                              label='پیام')
    name = forms.CharField(max_length=250, widget=forms.TextInput(attrs={'class': 'form-control'}), required=True,
                           label='نام')
    email = forms.EmailField(widget=forms.TextInput(attrs={'class': 'form-control'}), label='ایمیل')
    phone = forms.CharField(max_length=11, widget=forms.TextInput(attrs={'class': 'form-control'}), required=True,
                            label='شماره تماس')
